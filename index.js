...
userPreference == 'Sugar-free' ? console.log(`User preference is: ${userPreference}`) :
console.log(`User preference is: ${'Regular'}`);
...
cansLeft < 5 ? console.log('Time to Restock!'): console.log("Were stocked!");
...
let currentHour = 22; 
currentHour >= 7 && currentHour < 24 ? console.log(`Unleash the beast!`): console.log(`Better to stick to water`);
